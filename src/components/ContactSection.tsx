...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwfPHH6xg5X0YlYXJqzLvPgdHN9NYxD2D2XhYmFHpVZfPX_Hg1rOQKdMRDVhKzB1Mwi/exec';
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const submissionData = {
        ...
        challenge: formData.challenge.trim() || 'Not specified',
      ...
      // Still show success as no-cors doesn't return proper response
      setShowSuccessModal(true);
      setFormData({
        name: '',
        businessType: '',
