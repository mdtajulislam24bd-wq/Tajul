        ...
        <motion.div initial={{
          ...
          <div className="relative">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <img src={tajulImage} alt="Tajul Islam - Digital Marketing Specialist & Meta Ads Expert in Dhaka, Bangladesh" className="w-full max-w-lg lg:max-w-xl object-contain drop-shadow-2xl" />
            ...
            <motion.div initial={{
              ...
              delay: 1.2,
              duration: 0.6
            }} className="absolute -left-2 md:left-0 bottom-1/4 glass-card rounded-2xl p-4 shadow-elevated bg-background/80 backdrop-blur-md border border-white/20">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-gold flex items-center justify-center">
                  <span className="text-xl">🎯</span>
                </div>
