...
const caseStudies = [{
  ...
  approach: 'Implemented TOF/MOF Strategy, fixed offer messaging, retargeted abandoned carts.',
  revenue: '$25,850',
  adSpend: '$5k'
}, {
  industry: 'Cafe Chain',
  ...
  approach: 'Local Awareness (TOF) + Retargeting (MOF) for footfall. Loyalty system setup.',
  revenue: '$18,200',
  adSpend: '$4.7k'
}, {
  ...
  approach: 'Full Funnel Deployment: Dynamic Product Ads (DPA) + Email Automation (BOF).',
  revenue: '$45,000',
  adSpend: '$7.2k'
}, {
  ...
  approach: 'Lead Generation Funnel: Free Trial Offer -> Email Nurture -> Membership Conversion.',
  revenue: '$12,500',
  adSpend: '$2.8k'
}, {
  industry: 'Restaurant',
  ...
  approach: 'Geo-fenced Ads + Influencer Content (TOF) -> Reservation Retargeting (BOF).',
  revenue: '$22,000',
  adSpend: '$4.6k'
}, {
  ...
  approach: 'Lifestyle Video Ads (TOF) + Collection Ads (MOF) + CAPI Tracking.',
  revenue: '$16,800',
  adSpend: '$4.3k'
}];
